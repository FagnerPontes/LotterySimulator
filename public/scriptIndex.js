...
var myHeigth = 0; //valor constate para evitar redimensionamento
...
function checkOrientation() {
  if (isMobile) {
    if (window.innerHeight < 600) {
      document.documentElement.style.setProperty('--d1_dHomeHeight', '600px');
      document.documentElement.style.setProperty('--mobileHeight', '600px');
    }
    else {
      document.documentElement.style.setProperty('--d1_dHomeHeight', `${myHeigth}px`); //valor constate para evitar redimensionamento
    ...
    if (window.innerHeight < 600) {
      ...
      document.documentElement.style.setProperty('--d1_dHomeHeight', `100vh`);
      document.documentElement.style.setProperty('--mobileHeight', `100vh`);
    }
  }
}
...
onresize = (event) => {
  ...
  //caso a largura da janela seja maoir que 900px (monitor) -> abrir os menus
  else {
    document.documentElement.style.setProperty('--menuWidth', '18rem'); //variável css (--menuWidth):
